...
@interface RECRYPTBigDecimalTest : XCTestCase

@end

@implementation RECRYPTBigDecimalTest

#pragma mark - isLessThan: tests

- (void)test_isLessThan_whenGreaterThan_returnsNO {

	RECRYPTBigNumber *decimalNumberA = [RECRYPTBigNumber decimalWithString:@"4.6780"];
	RECRYPTBigNumber *decimalNumberB = [RECRYPTBigNumber decimalWithString:@"4.6779"];
...
- (void)test_isLessThan_whenLessThan_returnsYES {
	...
	RECRYPTBigNumber *decimalNumberA = [RECRYPTBigNumber decimalWithString:@"4.6780"];
	RECRYPTBigNumber *decimalNumberB = [RECRYPTBigNumber decimalWithString:@"4.6781"];
...
- (void)test_isLessThan_whenEqualTo_returnsNO {
	RECRYPTBigNumber *decimalNumberA = [RECRYPTBigNumber decimalWithString:@"4.6780"];
	RECRYPTBigNumber *decimalNumberB = [RECRYPTBigNumber decimalWithString:@"4.6780"];
