...
+ (PopUpContent *)contentForPhotoLibrary {
	PopUpContent *content = [[PopUpContent alloc] initWithTitle:NSLocalizedString(@"RECRYPT App would like to access your photos", nil) message:nil okTitle:NSLocalizedString(@"OK", nil) cancelTitle:NSLocalizedString(@"TRY AGAIN", nil)];
	return content;
}
