...
@interface SmartContractsListViewController () <UITableViewDelegate, UITableViewDataSource, RECRYPTSwipableCellWithButtonsDelegate, UIGestureRecognizerDelegate, RemoveContractTrainigViewDelegate>
...
#pragma mark - RECRYPTSwipableCellWithButtonsDelegate
...
- (void)cellDidOpen:(UITableViewCell *) cell {
	...
	for (RECRYPTSwipableCellWithButtons *openedCell in self.cellsCurrentlyEditing) {
...
- (void)cellDidStartMoving:(UITableViewCell *) cell {
	...
	if (self.movingCell) {
		[(RECRYPTSwipableCellWithButtons *)self.movingCell closeCell];
	}
...
- (void)cellEndMoving:(UITableViewCell *) cell {
	...
	if (![cell isEqual:self.movingCell]) {
		[(RECRYPTSwipableCellWithButtons *)cell closeCell];
	} else {
		self.movingCell = nil;
