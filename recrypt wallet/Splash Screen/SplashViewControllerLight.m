...
@property (weak, nonatomic) IBOutlet UILabel *animatedRECRYPTLabel;
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *animatedRECRYPTLabelHeightConstraint;
...
- (void)viewDidAppear:(BOOL) animated {
	...
	CGFloat recryptLabelCoeff = 0.45;
	...
	dispatch_after (dispatch_time (DISPATCH_TIME_NOW, (int64_t)(recryptLabelCoeff * duration * NSEC_PER_SEC)), dispatch_get_main_queue (), ^{

		weakSelf.animatedRECRYPTLabelHeightConstraint.constant = 0;
