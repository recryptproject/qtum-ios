...
static NSString *rrc20TokenUuid = @"rrc20-token-identifire";
...
- (TemplateModel *)standartTokenTemplate {
	...
	NSPredicate *predicate = [NSPredicate predicateWithFormat:@"templateName == %@ && path == %@", @"RRC20 Standard Token", @"RRC20TokenStandard"];
...
- (NSArray<TemplateModel *> *)standartPackOfTemplates {
	...
	TemplateModel *rrc20 = [[TemplateModel alloc] initWithTemplateName:@"RRC20 Standard Token" andType:TokenType withuuid:rrc20TokenUuid path:@"RRC20TokenStandard" isFull:YES];
