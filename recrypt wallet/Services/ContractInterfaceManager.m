...
- (InterfaceInputFormModel *)tokenRRC20Interface {
	...
	InterfaceInputFormModel *interphase = [[InterfaceInputFormModel alloc] initWithAbi:[self getRRC20TokenStandartAbiInterface]];
	return interphase;
}
...
- (BOOL)isERCTokenStandartInterface:(NSArray *) interface {
	...
	NSArray *rrc20interface = [self getRRC20TokenStandartAbiInterface];
	return [self isInterfaceArray:interface equalRRC20InterfaceArray:rrc20interface];
}
...
- (BOOL)isInterfaceArray:(NSArray *) intefaceArray equalRRC20InterfaceArray:(NSArray *) rrc20 {
	...
	BOOL isSubset = [[NSSet setWithArray:rrc20] isSubsetOfSet:[NSSet setWithArray:intefaceArray]];
	return isSubset;
}
