...
@implementation RECRYPTHTMLTagItem
...
- (BOOL)isEqualToTagItem:(RECRYPTHTMLTagItem *) aTagItem {
...
- (BOOL)isEqual:(id) anObject {
	...
	if (![anObject isKindOfClass:[RECRYPTHTMLTagItem class]]) {
		return NO;
	}

	return [self isEqualToTagItem:(RECRYPTHTMLTagItem *)anObject];
}
