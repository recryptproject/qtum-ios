...
@implementation RECRYPTFeedItem
...
- (BOOL)isEqualToFeedItem:(RECRYPTFeedItem *) aFeedItem {
...
- (BOOL)isEqual:(id) anObject {
	...
	if (![anObject isKindOfClass:[RECRYPTFeedItem class]]) {
		return NO;
	}

	return [self isEqualToFeedItem:(RECRYPTFeedItem *)anObject];
}
