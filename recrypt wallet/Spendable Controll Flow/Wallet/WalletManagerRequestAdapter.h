...
- (void)getBalanceForAddreses:(NSArray *) keyAddreses withSuccessHandler:(void (^)(RECRYPTBigNumber *balance)) success andFailureHandler:(void (^)(NSError *error, NSString *message)) failure;
